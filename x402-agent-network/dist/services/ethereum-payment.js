...
class EthereumPaymentProcessor {
    constructor(config) {
        this.paymentLog = path.join(__dirname, '../../logs/ethereum-payments.log');
        this.config = {
     ...
     */
    async verifyViaEtherscan(txHash) {
        try {
     ...
     */
    async verifyPaymentRecipient(txHash) {
        try {
...
//# sourceMappingURL=ethereum-payment.js.map