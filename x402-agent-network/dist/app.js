...
if (telegramBotToken) {
    try {
        ...
        telegramBridge = new TelegramAgentBridge(webhookSecret, telegramBotToken, null, // SmartEscrowClient
        null // SolanaIntegration
        );
...
app.get("/.well-known/:file", (req, res) => { res.sendFile(req.params.file, { root: "public/.well-known", dotfiles: "allow" }); });
