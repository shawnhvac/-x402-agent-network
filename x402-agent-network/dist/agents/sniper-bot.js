...
export class SniperBotAgent {
    constructor() {
        ...
        this.baseCost = 0.25; // Base USDC per snipe (scales with speed)
        this.maxCost = 1.0; // Max cost for priority execution
    ...
    async execute(request) {
        try {
            const { tokenAddress = "0x...", buyAmount = 1.0, slippage = 1.0, priority = false, } = request.input || {};
