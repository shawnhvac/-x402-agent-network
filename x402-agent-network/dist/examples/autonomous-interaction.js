...
// ===== EXAMPLE SCENARIO =====
async function runAutonomousInteractionExample() {
    console.log('\n');
    ...
    const mechanic1 = new MechanicAgent('mechanic-bob-001', '0xBob1111111111111111111111111111111111111', 'Bob\'s Quick Service', [
        {
            serviceType: 'tune-up',
            basePrice: 100,
            estimatedTime: 120,
    ...
    const mechanic2 = new MechanicAgent('mechanic-alice-001', '0xAlice1111111111111111111111111111111111', 'Alice\'s Pro Garage', [
        {
            serviceType: 'tune-up',
            basePrice: 120,
            estimatedTime: 90,
    ...
    const mechanic3 = new MechanicAgent('mechanic-charlie-001', '0xCharlie111111111111111111111111111111111', 'Charlie\'s Budget Service', [
        {
            serviceType: 'tune-up',
            basePrice: 80,
            estimatedTime: 150,
    ...
    const vehicle = new VehicleAgent('tesla-model-3-001', '0xVehicle1111111111111111111111111111111', 'Model 3 VIN: ABC123', new AutonomousNegotiationEngine('0xVehicle1111111111111111111111111111111', registry));
    ...
    if (lastResult) {
        ...
        if (selectedMechanic) {
            ...
            const job = selectedMechanic.acceptEscrow(lastResult.escrowId, vehicle.getWalletAddress(), 'tune-up', lastResult.selectedPrice, lastResult.selectedTime);
            // Simulate work completion
            console.log('⏳ Mechanic performing work...\n');
            await delay(1000);
            // Complete milestone
            const milestone = selectedMechanic.completeMilestone(lastResult.escrowId, 0, 'Service completion');
            if (milestone) {
                // Simulate payment
                console.log('─'.repeat(70) + '\n');
                selectedMechanic.receivePayment(lastResult.escrowId, lastResult.selectedPrice, 'tune-up service');
...
//# sourceMappingURL=autonomous-interaction.js.map