...
function paymentMiddlewareFromHTTPServer(httpServer, paywallConfig, paywall, syncFacilitatorOnStart = true) {
  ...
  return async (req, res, next) => {
    ...
    console.log("[x402-DEBUG] path:", req.path, "method:", req.method, "paymentHeader:", context.paymentHeader ? context.paymentHeader.slice(0,30)+"..." : "NONE", "all-headers:", JSON.stringify(Object.keys(req.headers)));
    ...
    console.log("[x402-DEBUG] processHTTPRequest result.type:", result.type, result.type === "payment-error" ? JSON.stringify(result.response?.body || result.response?.status) : "");
    switch (result.type) {
