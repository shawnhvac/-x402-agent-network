...
import { Plus, Settings, TrendingUp, Users, DollarSign, Edit2 } from 'lucide-react';
...
type TabType = 'overview' | 'edit' | 'earnings' | 'settings';
      ...
      <div className="bg-gray-800 border border-gray-700 rounded-lg p-8">
        ...
        >
          ...
          <div>
            ...
            <textarea
              placeholder="Sign message with your wallet..."
              className="w-full px-4 py-2 bg-gray-700 border border-gray-600 rounded-lg text-white placeholder-gray-500 focus:outline-none focus:border-green-500 h-24"
            />
          </div>
        ...
        <form onSubmit={handleSubmit} className="space-y-6">
          ...
          <div>
            ...
            <textarea
              ...
              onChange={handleChange}
              placeholder="Describe your agent and services..."
              className="w-full px-4 py-2 bg-gray-700 border border-gray-600 rounded-lg text-white placeholder-gray-500 focus:outline-none focus:border-green-500 h-24"
            />
          </div>
          ...
          <div>
            ...
            <input
              ...
              onChange={handleChange}
              placeholder="Your Solana wallet (for receiving payments)"
              className="w-full px-4 py-2 bg-gray-700 border border-gray-600 rounded-lg text-white placeholder-gray-500 focus:outline-none focus:border-green-500"
            />
          </div>
 ...
 * Edit Profile Tab
 */
function EditProfileTab({ agent }: { agent: AgentProfile }) {
  return (
 ...
 * Earnings Tab
 */
function EarningsTab({ agent }: { agent: AgentProfile }) {
  return (
 ...
 * Settings Tab
 */
function SettingsTab({ agent }: { agent: AgentProfile }) {
  return (
    <div className="space-y-6">
      <div className="bg-gray-800 border border-gray-700 rounded-lg p-8">
        <h3 className="text-xl font-bold text-white mb-6 flex items-center gap-2">
