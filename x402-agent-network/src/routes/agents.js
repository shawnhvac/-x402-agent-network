...
router.get("/", async (req, res) => {
    try {
        // @ts-ignore - ignore query type issues
        const agents = getAgents(req.query.chain ? req.query.chain : undefined, req.query.minRating ? parseFloat(req.query.minRating) : undefined);
        res.json({
            total: agents.length,
            agents: agents
        });
...
router.put("/:agentId", async (req, res) => {
    try {
        ...
        // @ts-ignore - ignore type issues for update data
