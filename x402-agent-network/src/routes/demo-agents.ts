 ...
 */
router.post("/grid-trader", async (req: Request, res: Response): Promise<any> => {
  try {
 ...
 */
router.post("/sniper-bot", async (req: Request, res: Response): Promise<any> => {
  try {
    const requester = req.headers["x-requester-wallet"] as string;
    const txHash = req.headers["x-payment-txhash"] as string | undefined;
 ...
 */
router.post("/llm-inference", async (req: Request, res: Response): Promise<any> => {
  try {
    const requester = req.headers["x-requester-wallet"] as string;
    const txHash = req.headers["x-payment-txhash"] as string | undefined;
 ...
 */
router.post("/data-feed", async (req: Request, res: Response): Promise<any> => {
  try {
    const requester = req.headers["x-requester-wallet"] as string;
    const txHash = req.headers["x-payment-txhash"] as string | undefined;
 ...
 */
router.get("/agents-info", (req: Request, res: Response) => {
  res.json({
    agents: [
      {
