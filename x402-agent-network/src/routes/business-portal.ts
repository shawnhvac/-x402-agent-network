...
let businesses: Map<string, BusinessProfile> = new Map();
 ...
 * Login business
 */
router.post('/business/login', (req: Request, res: Response) => {
  try {
 ...
 */
router.put('/business/:id', (req: Request, res: Response) => {
  try {
    const business = businesses.get(req.params.id);
 ...
 * Add a new service
 */
router.post('/business/:id/services', (req: Request, res: Response) => {
  try {
    const business = businesses.get(req.params.id);
 ...
 */
router.get('/business/:id/services', (req: Request, res: Response) => {
  try {
    const business = businesses.get(req.params.id);
 ...
 * Update a service
 */
router.put('/business/:businessId/services/:serviceId', (req: Request, res: Response) => {
  try {
 ...
 * Delete a service
 */
router.delete('/business/:businessId/services/:serviceId', (req: Request, res: Response) => {
  try {
    const business = businesses.get(req.params.businessId);
 ...
 */
router.get('/business/:id/bookings', (req: Request, res: Response) => {
  try {
 ...
 */
router.put('/business/:businessId/bookings/:bookingId', (req: Request, res: Response) => {
  try {
 ...
 */
router.get('/business/:id/analytics', (req: Request, res: Response) => {
  try {
    const businessBookings = Array.from(bookings.values()).filter(b => b.businessId === req.params.id);
