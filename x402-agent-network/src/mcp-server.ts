...
const searchServicesTool = {
  ...
  description:
    "Search for available services by category, location, and date. Returns list of providers with pricing, ratings, and availability.",
  inputSchema: {
...
const bookServiceTool = {
  name: "book_service",
  description:
    "Book a service appointment at a specific time and location. Requires confirmation before payment.",
  inputSchema: {
    type: "object" as const,
    properties: {
      service_id: {
...
const payForServiceTool = {
  ...
  description:
    "Complete payment for a booked service using x402 protocol. Funds are locked in SmartEscrow until service completion.",
  inputSchema: {
    type: "object" as const,
    properties: {
      booking_id: {
